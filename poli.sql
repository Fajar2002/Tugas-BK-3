...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2024 at 02:26 PM
...
(1, 'Dimas', 'Pleburan', '081234567890', 1),
(2, 'Bambang Sugeni', 'Kedung Mundu', '081234567846', 2),
(3, 'Eko Prasetyo', 'Tlogosari', '08129876543', 3);
...
(8, 'Iqbal', 'Bandung', '8882681538962153', '708327130720', '4');
...
(1, 'Poli Jantung', 'Poli Jantung merupakan salah satu unit poliklinik rawat jalan dengan konsentrasi layanan pasien yang mengalami kelainan/gangguan jantung dan pembuluh darah (kardiovaskuler).'),
(2, 'Poli Umum', 'Poli umum adalah poliklinik yang menyediakan pelayanan medis untuk pasien umum atau pasien tanpa kondisi kesehatan yang spesifik.'),
(3, 'Poli Gigi', 'Poli gigi adalah poliklinik yang khusus menangani masalah kesehatan gigi dan mulut.');
...
(1, '', 'tegar', '$2y$10$Is/i1prQbHykWh4ozgakSOWI2B7aPBzai5pErFRWegQyWcNbMEX6S', ''),
(2, 'tegar', 'tegar', '123', 'admin'),
(3, 'naufal', 'naufal', '123', 'dokter'),
(4, 'devan', 'devan', '123', 'pasien');
