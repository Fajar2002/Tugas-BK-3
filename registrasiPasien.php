    ...
    <div class="sidebar">
      <!-- Sidebar user panel (optional) -->
	   ...
	   <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="registrasiPasien.php" class="nav-link">
...
if (isset($_POST['simpan'])) {
    ...
    echo "<script> 
                document.location='registrasiPasien.php';
                </script>";
}
if (isset($_GET['aksi'])) {
    if ($_GET['aksi'] == 'hapus') {
...
<div class="container">
    ...
    <form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
        ...
        <div class="row mt-1">
            ...
            <div>
                <input type="text" class="form-control" name="alamat" id="inputKemasan" placeholder="alamat" value="<?php echo $alamat ?>">
            </div>
        </div>
        <div class="row mt-1">
            ...
            <div>
                <input type="text" class="form-control" name="no_ktp" id="inputno_ktp" placeholder="NIK" value="<?php echo $no_ktp ?>">
            </div>
        </div>
                <div class="row mt-1">
            <label for="inputHarga" class="form-label fw-bold">
            ...
            <div>
                <input type="text" class="form-control" name="no_hp" id="inputno_hp" placeholder="NO HANDPHONE" value="<?php echo $no_hp ?>">
            </div>
        </div>
        <div class="row mt-3">
            <div class=col>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success rounded-pill px-3" href="registrasiPasien.php?page=obat&id=<?php echo $data['id'] ?>">Ubah</a>
                        <a class="btn btn-danger rounded-pill px-3" href="registrasiPasien.php?page=obat&id=<?php echo $data['id'] ?>&aksi=hapus">Hapus</a>
                    </td>
                </tr>
            <?php
            }
